...
import MainCardTag from '../main/MainCardTag';
import { convertDateFormat } from '../../lib/lib'

const UserSmallGroupCard = ({ smallGroup }) => {
        ...
        >
            <CardActionArea onClick={onCardClick}>
                ...
                <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Typography gutterBottom variant="h6" mt={0.5}>
                        {smallGroup.name}
                    </Typography>
...
export default UserSmallGroupCard